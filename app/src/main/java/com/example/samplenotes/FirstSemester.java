    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cs.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),CsFirst.class);
        ...
        me.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),MeFirst.class);
        ...
        ec.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),EcFirst.class);
        ...
        ee.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),EeFirst.class);
        ...
        ce.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),CeFirst.class);
        ...
        bt.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                //Intent intent=new Intent(getApplicationContext(),BtFirst.class);
