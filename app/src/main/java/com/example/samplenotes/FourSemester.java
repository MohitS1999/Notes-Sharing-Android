    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cs.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),CsForth.class);
        ...
        me.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),MeForth.class);
        ...
        ec.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),EcForth.class);
        ...
        ee.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),EeForth.class);
                Toast.makeText(getApplicationContext(),"Electical Engineering",Toast.LENGTH_SHORT).show();
                startActivity(intent);
            }
        });
        ce.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),CeForth.class);
        ...
        bt.setOnClickListener(new View.OnClickListener(){
            ...
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),BtForth.class);
